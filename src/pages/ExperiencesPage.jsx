...
const ExperiencesPage = () => {
  ...
  const { servicesData } = useServices([
    ...
    'afternoon-charter', 'boat-3-4-day-charter', 'diving-3-4-day', 'diving-full-day', 'exclusive-charter', 'tailor-made', 'pre-designed'
  ]);
  ...
  const primaryBtn = "w-full bg-[#03c4c9] hover:bg-[#f5c842] hover:text-[#2d353b] text-[#1c2226] font-bold";
  ...
  const privateBoatImage = "https://hcypqomjisyqrczwjrgc.supabase.co/storage/v1/object/public/Experiences%20-%20Photos/Exclusive%20Boat%20Charter%20-%20Thumbnail%20-%20Photo.jpeg";
  ...
  return (
    <>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto mb-12">
            <motion.div {...fadeInUp} transition={{ delay: 0.1 }} className="bg-white dark:bg-[#162026] border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm hover:shadow-xl hover:border-[#03c4c9] transition-all duration-300 flex flex-col relative h-full">
              <Badge className="absolute top-4 right-4 bg-[#03c4c9] hover:bg-[#02aeb3] text-[#1c2226] font-bold border-none">Max 4 Guests</Badge>
              ...
              <div className="mt-auto pt-6 border-t border-gray-100 dark:border-gray-800">
                <Button onClick={() => openModal('Pre-designed diving charter - ¾ Day', preDesignedImage)} className="w-full bg-[#03c4c9] hover:bg-[#f5c842] hover:text-[#2d353b] text-[#1c2226] font-bold">BOOK THIS OPTION</Button>
              </div>
            </motion.div>
            ...
            <motion.div {...fadeInUp} transition={{ delay: 0.2 }} className="bg-white dark:bg-[#162026] border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm hover:shadow-xl hover:border-[#03c4c9] transition-all duration-300 flex flex-col relative h-full">
              ...
              <div className="mt-auto pt-6 border-t border-gray-100 dark:border-gray-800">
                <Button onClick={() => openModal('Pre-designed diving charter - Full Day', preDesignedImage)} className="w-full bg-[#03c4c9] hover:bg-[#f5c842] hover:text-[#2d353b] text-[#1c2226] font-bold">BOOK THIS OPTION</Button>
              </div>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 bg-[#f5f7f9] dark:bg-[#111a1f]">
        <div className="container mx-auto max-w-7xl">
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto text-center mb-14">
            <h2 className="text-3xl font-bold mb-4">Private Boat Charters</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            {[
              ...
              <motion.div key={idx} {...fadeInUp} transition={{ delay: idx * 0.05 }} className="bg-white dark:bg-[#162026] border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm hover:shadow-xl hover:border-[#03c4c9] transition-all duration-300 flex flex-col relative h-full">
                ...
                <div className="mt-auto pt-6 border-t border-gray-100 dark:border-gray-800">
                  <Button onClick={() => openModal(`Private Boat Charter - ${option.title}`, privateBoatImage)} className="w-full bg-[#03c4c9] hover:bg-[#f5c842] hover:text-[#2d353b] text-[#1c2226] font-bold">BOOK THIS OPTION</Button>
                </div>
              </motion.div>
            ))}
          </div>
